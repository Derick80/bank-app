...
export const action: ActionFunction = async ({ request, params }) => {
    ...
    if(typeof description !== 'string' || typeof amount !== 'number' || typeof type !== 'string'   || typeof frequency !== 'string') {
...
export default function NewIncome() {
    ...
    const handleInputChange = (
        event: React.ChangeEvent<HTMLInputElement | HTMLFormElement | HTMLSelectElement>,
        field: string
    ) => {
        setFormData((form) => ({
            ...form,
